...
export default function AdminAnalytics() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* RIGHT CONTENT */}
      <div className="flex-1 page container-main">
        ...
        <div className="flex justify-center gap-4 mb-8">
          <button
            onClick={() => loadAnalytics(7)}
            className={`btn-dark px-5 py-2 rounded-lg ${
              days === 7 && "bg-primary text-black font-bold"
            }`}
          >
            Last 7 Days
          </button>
          ...
          <button
            onClick={() => loadAnalytics(30)}
            className={`btn-dark px-5 py-2 rounded-lg ${
              days === 30 && "bg-primary text-black font-bold"
            }`}
          >
            Last 30 Days
          </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <div className="card border border-green-500/40">
            <h2 className="text-sm text-gray-400 mb-1">Avg Order Value</h2>
        ...
        {!loading && daily.length > 0 && (
          <div className="space-y-10">
            ...
            <div className="card h-80">
              <h2 className="section-title text-primary text-left mb-3">
                Revenue (₹) per Day
              </h2>
              <Line
                data={revenueData}
            ...
            {/* ORDERS BAR + CATEGORIES DOUGHNUT */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">

              {/* ORDERS BAR */}
              <div className="card h-80 lg:col-span-2">
                <h2 className="section-title text-blue-400 text-left mb-3">
                  Orders per Day
                </h2>
                <Bar
                  data={ordersData}
              ...
              {/* CATEGORIES DOUGHNUT */}
              <div className="card h-80">
                <h2 className="section-title text-green-400 text-left mb-3">
                  Top Categories (₹)
                </h2>
            ...
            {/* TOP PRODUCTS TABLE */}
            <div className="card">
              <h2 className="section-title text-yellow-400 mb-3">
                Top Selling Products
              </h2>
